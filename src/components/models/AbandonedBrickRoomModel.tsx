...
import { Group, Mesh, MeshStandardMaterial } from "three/src/Three.js";
import { forwardRef } from "react";

export const AbandonedBrickRoomModel = forwardRef<Group, {} & GroupProps>(
  ({ ...props }, ref) => {
          ...
          <group rotation={[Math.PI / 2, 0, 0]}>
            <group rotation={[-Math.PI / 2, 0, 0]}>
              ...
              <mesh
                ...
                receiveShadow
                geometry={
                  nodes["Factory002_WindowsIndustrial-frontSolid_Mat_0"]
                    .geometry
                }
